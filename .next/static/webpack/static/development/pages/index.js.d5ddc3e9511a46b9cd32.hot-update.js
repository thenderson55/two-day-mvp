...
function (_React$Component) {
  ...
  function Index() {
    ...
    _this.state = {
      btc: 'Hello',
      cards: [{
        name: _data_fakeData__WEBPACK_IMPORTED_MODULE_12__["default"].data[0].name[0],
        description: _data_fakeData__WEBPACK_IMPORTED_MODULE_12__["default"].data.description[0],
        photo: _assets_spring_jpg__WEBPACK_IMPORTED_MODULE_13___default.a
      }, {
        name: _data_fakeData__WEBPACK_IMPORTED_MODULE_12__["default"].data.name[1],
        description: _data_fakeData__WEBPACK_IMPORTED_MODULE_12__["default"].data.description[1],
        photo: _assets_mountain_jpg__WEBPACK_IMPORTED_MODULE_14___default.a
      }, {
        name: _data_fakeData__WEBPACK_IMPORTED_MODULE_12__["default"].data.name[2],
        description: _data_fakeData__WEBPACK_IMPORTED_MODULE_12__["default"].data.description[2],
...
//# sourceMappingURL=index.js.d5ddc3e9511a46b9cd32.hot-update.js.map